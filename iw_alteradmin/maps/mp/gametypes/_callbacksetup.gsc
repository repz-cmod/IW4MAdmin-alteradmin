...
CodeCallback_StartGameType()
{
	...
	if(!isDefined(level.gametypestarted) || !level.gametypestarted)
	{
		...
		maps\mp\alteradmin::serverInitialize();
	}
}
...
CodeCallback_PlayerConnect()
{
	...
	thread maps\mp\alteradmin::playerInitialize();
...
CodeCallback_PlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, timeOffset)
{
	...
	maps\mp\alteradmin\damage::Callback_PlayerDamage_internal(eInflictor, eAttacker, self, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, timeOffset);
}
